...
type AnalyticsStat struct {
	...
	Alti              float32 `protobuf:"fixed32,4,opt,name=alti,proto3" json:"alti,omitempty"`
...
func (x *AnalyticsStat) GetLatitude() float32 {
	if x != nil {
		return x.Latitude
	}
	return 0
...
func (x *AnalyticsStat) GetLongitude() float32 {
	if x != nil {
		return x.Longitude
	}
	return 0
...
func (x *AnalyticsStat) GetAlti() float32 {
	if x != nil {
		return x.Alti
	}
	return 0
...
var file_analytics_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x04, 0x61, 0x6c, 0x74, 0x69, 0x12, 0x1c, 0x0a, 0x09, 0x72,
	...
	0x63, 0x6b, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x02, 0x52, 0x06, 0x72, 0x78, 0x41, 0x63, 0x6b,
